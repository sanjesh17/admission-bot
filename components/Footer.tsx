const Footer = () => {
  return (
    <footer className="bg-[#831238] text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/admissions" className="hover:text-gray-300">
                  Admissions
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/library" className="hover:text-gray-300">
                  Library
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="/alumni" className="hover:text-gray-300">
                  Alumni
                </a>
              </li>
              <li>
        ...
        <div className="mt-8 pt-8 border-t border-[#900000]">
          <p className="text-center">
            &copy; {new Date().getFullYear()} Sathyabama Institute of Science
